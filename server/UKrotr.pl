...
rule(r145a, standard, [pavement, notAccessProperty], [], [must-avoid_non_road_surfaces]).
rule(r145b, standard, [footpath, notAccessProperty], [], [must-avoid_non_road_surfaces]).
rule(r145c, standard, [bridleway, notAccessProperty], [], [must-avoid_non_road_surfaces]).
...
rule(r188, standard, [roundaboutsMini], [], [must-treat_as_roundabout,  must-pass_around,  should-avoid_uturn]).
